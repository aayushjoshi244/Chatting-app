          ...
          <div className="flex items-center justify-center w-full">
            <Tabs className="w-3/4" defaultValue="login">
              <TabsList className="bg-transparent rounded-none w-full">
                ...
                <TabsTrigger
                  value="signup"
                  className="data-[state=active]: bg-transparent text-opacity-90 border-b-2 rounded-none w-full data-[state=active]: text-black data-[state=active]:font-semibold data-[state=active]:border-b-pink-500 p-3 transition-all duration-300"
                >
                  SignUp
                </TabsTrigger>
              </TabsList>
              <TabsContent className="flex flex-col gap-5 mt-10" value="login">
                ...
                />
                <Button
                  className="rounded-full p-6 bg-purple-500"
                  onClick={handleLogin}
                >
                  Login
                </Button>
              ...
              <TabsContent className="flex flex-col gap-5 mt-10" value="signup">
                ...
                />
                <Button
                  className="rounded-full p-6 bg-pink-500"
